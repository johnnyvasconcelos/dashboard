        <aside>
          ...
          <ul>
            <li class="active">
              <a href="./index.html"
                ><img src="./assets/images/home.svg" alt="home svg" /><span
                  >Início</span
                ></a
              >
            </li>
              ...
              <ul class="submenu">
                <li>
                  <a href="./empresas.html">
                    <img src="./assets/images/book.svg" alt="home svg" /><span
                      >Ver Empresas</span
                    >
                  </a>
                </li>
                <li>
                  <a href="./cadastrar-empresa.html">
                    <img src="./assets/images/seed.svg" alt="home svg" /><span
                      >Cadastrar Empresa</span
                    >
                  </a>
                </li>
              </ul>
              ...
              <ul class="submenu">
                <li>
                  <a href="./usuarios.html">
                    <img src="./assets/images/users.svg" alt="home svg" /><span
                      >Usuários</span
                    >
                  </a>
                </li>
